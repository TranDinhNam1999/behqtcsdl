...
class Role(Base):
    ...
    can_edit_data = Column(Integer, server_default=0, nullable=False)
    can_edit_user = Column(Integer, server_default=0, nullable=False)
    can_manage_ui = Column(Integer, server_default=0, nullable=False)
